...
public class LaserBeam_old
{
    ...
    public LaserBeam_old(GameObject parentObject, List<float> waveLengths, float laserWidth, Vector3 laserStartPosition, Vector3 laserStartDirection)
    {
